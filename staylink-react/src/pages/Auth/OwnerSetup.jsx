        ...
        <section className="hidden md:flex md:w-[40%] relative p-10 flex-col justify-end">
          ...
          <div className="relative z-10 space-y-4">
            <h2 className="text-[#f9f9ff] text-3xl font-extrabold leading-tight">
              List Your Property,<br />Start Earning.
            </h2>
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-[#737685]" size={16} />
                <input
                  id="phone"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <MapPin className="absolute left-4 top-4 text-[#737685]" size={16} />
                <textarea
                  id="address"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative bg-[#f1f3ff] rounded-xl p-3">
                <Image className="absolute left-4 top-1/2 -translate-y-1/2 text-[#737685]" size={16} />
                <input
                  id="profile_image"
                  type="file"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative bg-[#f1f3ff] rounded-xl p-3">
                <FileText className="absolute left-4 top-1/2 -translate-y-1/2 text-[#737685]" size={16} />
                <input
                  id="id_proof"
                  type="file"
                  className="w-full pl-8 text-sm"
